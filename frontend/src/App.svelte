<script>
  // importamos ruteadores
  import Ruteador from "./rutas/Ruteador.svelte";
  import Ruta from "./rutas/Ruta.svelte";
  import NoEncontrado from "./rutas/NoEncontrado.svelte";
  ...
  import HistorialDispositivo from "./componentes/HistorialDispositivo.svelte";
</script>
...
<main>
  ...
  <Ruteador>
    ...
    <Ruta path="/dispositivos/:id/historial" componente={HistorialDispositivo} let:parametros />    
